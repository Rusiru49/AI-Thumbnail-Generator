...
export default function TrustedCompanies() {
    return (
        <section className="flex flex-col items-center">
            <SectionTitle
                title="Trusted by Creators & Teams"
                description="Creators, startups, and marketing teams rely on our AI to generate high-performing thumbnails at scale."
            />
            ...
            >
                ...
                <div className="flex flex-col items-center md:items-start max-md:text-center">
                    ...
                    >
                        ...
                        <p className="flex items-center gap-1">
                            <span>Generate your first thumbnail today</span>
                            <svg
                    ...
                    <p className="text-base text-slate-400 max-w-lg mt-4">
                        Our AI thumbnail generator helps creators increase click-through rates,
                        save time, and publish content faster — without design skills.
                    </p>
                ...
                <div className="md:-mr-16 max-md:mt-10">
                    <img
                        ...
                        alt="Trusted creators and brands"
                    />
                </div>
            </motion.div>
        </section>
