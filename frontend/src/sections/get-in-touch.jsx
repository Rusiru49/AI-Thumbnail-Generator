...
export default function GetInTouch() {
    return (
        <section className="flex flex-col items-center" id="contact">
            <SectionTitle 
                title="Let’s Create Something Eye-Catching"
                description="Have a question, feedback, or a custom thumbnail idea? We’d love to hear from you."
            />
            ...
            >
                ...
                >
                    ...
                    <textarea
                        name="message"
                        rows={8}
                        placeholder="Tell us about your thumbnail idea, platform (YouTube, Instagram, etc.), or any questions you have..."
                ...
                <motion.button
                    type="submit"
                    className="w-max flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 rounded-full active:scale-95 transition"
                    initial={{ y: 150, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    viewport={{ once: true }}
                    transition={{ type: "spring", stiffness: 280, damping: 70, mass: 1 }}
